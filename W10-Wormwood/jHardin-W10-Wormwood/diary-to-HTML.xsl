...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                    ...
                    <p>
                        <ol>
                                                       <xsl:for-each select="//d:entries//d:place" xml:space="preserve">
                                                                <li><xsl:value-of select="."/> (<xsl:value-of select="@type"/>)</li> <!-- JH changed the li placement to get rid of weird spacing  -->
                                                            </xsl:for-each>
                        </ol>
                    </p>
                </div>
    ...
    <xsl:template match="d:quote"> <!-- JH removed quotes  -->
