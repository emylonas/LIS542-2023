...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:d="W10-Wormwood-Source-WW.xml" exclude-result-prefixes="xs xd" version="2.0">
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <h1>
                    <xsl:value-of select="/d:journal/d:metadata/d:sourceInfo/d:author/d:name/d:digitizationdate"/>
                </h1>
                <xsl:apply-templates/>
