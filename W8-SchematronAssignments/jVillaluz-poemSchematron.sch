...
<pattern>
 ...
 <pattern>
      <rule context="tei:div/.">
          <assert test="starts-with(@n,'poem')">must be a poem</assert>
      </rule>         
 </pattern>
    ...
    <pattern>
        <rule context="tei:l/@n">
            <assert test="string-length(.) = 3">must have at least 3 digits</assert>
        </rule>      
    </pattern>
    ...
    <pattern>
        <rule context="tei:revisionDesc/change">
           <assert test="string-length(.) = 0">Missing content</assert>
        </rule>
    </pattern>
    ...
    <pattern>
        <rule context="tei:div">
            <assert test="@type=sonnet or @type=limerick">need to contain either sonnet or limerick</assert>
        </rule>        
    </pattern>
    ...
    <pattern>
            <rule context="tei:l[ancestor::div[type='foo']]">
                <assert test="@rhyme">sonnet must rhyme</assert>
            </rule>      
    </pattern>
    ...
    <pattern>
            <rule context="tei:lg">
                <assert test="contains(l,lb)">l must have lb after</assert>
            </rule>       
    </pattern>
   ...
   -->
    ...
    <pattern>
        <rule context="tei:l[13]">
            <assert test="contains('war','love')">must contain war or love</assert>
        </rule>      
    </pattern>
