...
<pattern>
    <rule context="tei:l">
        <assert test="sum (lb) lt 1">An l element must include lb element</assert>
    </rule>
</pattern>
    ...
    <pattern>
        <rule context="tei:l/@n">
            <assert test="string-length ()ge 3">An n attribute=0001 is true</assert>
        </rule>
    ...
    <pattern>
        <rule context="tei:RevisionDesc/tei:change">
            <assert test="string-length() ne 0">A change element in RevisionDesc must have no content</assert>
        </rule>
    </pattern>
    ...
    <pattern>
        <rule context="tei:div/@type">
            <assert test="starts-with(.,'sonnet', 'limerick')">A div element must start with "sonnet" or "limerick"</assert>
        </rule>
    </pattern>
    ...
    <pattern>
        <rule context="tei:l/@rhyme">
            <assert test="count(@ryhme)"> l elements must have rhyme attributes</assert>
        </rule>
    </pattern>
   ...
   -->
    ...
    <pattern>
      <rule context="tei:l/lb">
          <assert test="contains(l, lb)">An l element must include an lb element</assert>
      </rule>   
    </pattern>
   ...
   -->
    ...
    <pattern>
        <rule context="tei:l/limerick">
            <assert test="string-length() ge 5">An l element must contain a limerick</assert>
        </rule>
    </pattern>
