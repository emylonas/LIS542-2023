    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div>
                    <h1>List of Names</h1>
                    <!--HF: The spacing here was messed up and created list items between each item containing text. This has been fixed.-->
                    <!--HF: Also, wanted to remove the empty brackets for names without an assigned @role, hence the xsl:choose statement.-->
                    <p>
                        <ol>
                ...
                <!--Modification 5: Breaking @role out into its own list.-->
                <div>
                    <h1>List of Roles</h1>
                    <p>
                        <ol>
...
<!--Modification 1-->
    <xsl:template match="d:pb"> 
        <p>
        [<xsl:value-of select="concat('page ',translate(@n, 'page0', ''))"/>]  
        <xsl:apply-templates/>
        </p>
    </xsl:template>
