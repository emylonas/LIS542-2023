    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <h1>[<xsl:value-of select="/d:journal/d:entries/d:entry/d:p/@n"></xsl:value-of>]
                    </h1>
                  <xsl:apply-templates/>
                
                <h1>
                    "<xsl:value-of select="/d:journal/d:entries/d:entry/d:p/d:q"/>"
                        <xsl:apply-templates/>
                </h1>
                
                <h1>
                    [<xsl:value-of select="@ref"/>]
                    <a href="https://www.kingjamesbibleonline.org/Titus-3-5/">3 Tit. 5<xsl:apply-templates/></a>
                </h1>
                    ...
                    <p>
                        <ol>
                                                       <xsl:for-each select="//d:entries//d:place" xml:space="preserve">
                                                                <li>
                                                                      <xsl:value-of select="."/> <xsl:value-of select="@place"/>
                                                                    </li>
                                                            </xsl:for-each>
                        </ol>
                    </p>
